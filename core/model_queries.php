    ...
    public static function plugin_install(){
        ...
        if (version_compare(PHP_VERSION, '5.2.3', '<')) {
            ...
            wp_die(
                ...
                .sprintf(__('Page Security requires PHP 5.2.3 or higher. Your server is running PHP %s. Please contact your hosting service about enabling PHP 5.2 support.','contexture-page-security'),PHP_VERSION)
