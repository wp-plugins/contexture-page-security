    ...
    if(!current_user_can('manage_options') && !is_home() && !is_category() && !is_tag()) {
        ...
        if(!!$pagereqs){
            ...
            if($secureallowed){
                ...
                if($current_user->ID == 0){
                    //header('Location: /wp-login.php?ctx_ps_msg=nogroup');
                    wp_die('You do not have the appropriate group permissions to access this page. Please try <a href="/wp-login.php">logging in</a> or contact an administrator for assistance.<a style="display:block;font-size:0.7em;padding-top:1em;" href="/">&lt;&lt; Go to home page</a>');
                }else{
